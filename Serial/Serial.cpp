...
SerialInfo::SerialInfo(const SerialInfo& info) : port_name(info.port_name), device(info.device)
{

}

SerialInfo::SerialInfo(const Tstring& _port) : port_name(_port)
{
...
SerialInfo::SerialInfo(const Tstring& _port, const Tstring& _device_name) : port_name(_port), device(_device_name)
{
